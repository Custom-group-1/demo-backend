...
import {
  ...
  TraceType,
  Eidolon,
  SummonConfig, // [ADDED] SummonConfig
} from './entities/User';
...
async function bootstrap() {
  ...
  const hackerspace = em.create(RelicSet, {
    name: 'Messenger Traversing Hackerspace',
  });
  const hacker4pc = em.create(RelicMove, {
    relicSet: hackerspace,
    pieceRequirement: 4,
  });
  em.create(Effect, {
    relicMove: hacker4pc,
  ...
  const eagle4pc = em.create(RelicMove, {
    relicSet: eagle,
    pieceRequirement: 4,
  });
  em.create(Effect, {
  ...
  const vonwacq2pc = em.create(RelicMove, {
    relicSet: vonwacq,
    pieceRequirement: 2,
  });
  em.create(Effect, {
  ...
  const astaUlt = em.create(Move, {
    character: asta,
    moveType: MoveType.ULT,
    moveName: 'Astral Blewits',
    isEnhanced: false,
    resourceCostAmount: 0,
  });
  em.create(Effect, {
  ...
  const dhSkill = em.create(Move, {
    character: danheng,
    moveType: MoveType.SKILL,
    moveName: 'Cloudlancer Art: Torrent',
    isEnhanced: false,
    resourceCostAmount: 0,
  });
  em.create(Effect, {
  ...
  const rmTrace = em.create(Trace, {
    character: ruanMei,
    type: TraceType.TALENT,
    description: 'Somatotypical GHelix',
  });
  em.create(Effect, {
    trace: rmTrace,
    effectType: EffectType.SPEED_PERCENT,
  ...
  em.create(Effect, {
    ...
    effectType: EffectType.SPEED_PERCENT,
    effectValue: '0.12',
    triggerCondition: 'talent_active == true',
    durationUnit: DurationUnit.TURN,
    maxStacks: 1,
  });
  ...
  em.create(Effect, {
    ...
    effectType: EffectType.SPEED_PERCENT,
    effectValue: '0.30',
    triggerCondition: "move_type == 'skill'",
    durationUnit: DurationUnit.TURN,
    durationValue: 1,
    maxStacks: 1,
  });
  ...
  const hanyaTalent = em.create(Trace, {
    character: hanya,
    type: TraceType.TALENT,
  ...
  const jlTalent = em.create(Trace, {
    character: jingliu,
    type: TraceType.TALENT,
    description: 'Crescent Transmigration',
  });
  em.create(Effect, {
    trace: jlTalent,
    effectType: EffectType.ACTION_ADVANCE,
    effectValue: '100.00',
    triggerCondition: 'stacks == 2',
    durationUnit: DurationUnit.ACTION,
    maxStacks: 1,
  });
  ...
  const astaTalent = em.create(Trace, {
    character: asta,
    type: TraceType.TALENT,
  ...
  em.create(Effect, {
    ...
    effectValue: '10.00',
    maxStacks: 5,
    triggerCondition: 'per_stack',
    durationUnit: DurationUnit.PERMANENT,
  });

  // --- SUSHANG TALENT (Speed on Break) ---
  const sushangTalent = em.create(Trace, {
    character: sushang,
    type: TraceType.TALENT,
  ...
  em.create(Effect, {
    ...
    effectType: EffectType.SPEED_PERCENT,
    effectValue: '0.20',
    triggerCondition: 'enemy_weakness_break',
    durationUnit: DurationUnit.TURN,
    durationValue: 2,
    maxStacks: 1,
  });
  ...
  const qqA2 = em.create(Trace, {
    character: qq,
    type: TraceType.A2,
    description: 'Tile Battle',
  });
  em.create(Effect, {
    trace: qqA2,
    effectType: EffectType.SPEED_PERCENT,
    effectValue: '0.10',
    triggerCondition: 'move_is_enhanced == true',
    durationUnit: DurationUnit.TURN,
    durationValue: 1,
    maxStacks: 1,
  });
  ...
  em.create(Effect, {
    ...
    effectValue: '0.10',
    maxStacks: 5,
    triggerCondition: 'talent_triggered',
    durationUnit: DurationUnit.TURN,
  });

  // --- SILVER WOLF (Talent Slow) ---
  const sw = charMap.get('Silver Wolf')!;
  const swTalent = em.create(Trace, {
    character: sw,
    type: TraceType.TALENT,
    description: 'Awaiting System Response...',
  });
  em.create(Effect, {
    trace: swTalent,
    effectType: EffectType.SPEED_PERCENT,
    effectValue: '-0.10',
    triggerCondition: 'on_attack_random',
    durationUnit: DurationUnit.TURN,
    maxStacks: 1,
  });
